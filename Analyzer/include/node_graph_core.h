...
extern node_t *make_node(const std::string name, const int node_index, const int core,
...
extern bool search_parent_nodes(node_t *root_node, int node_index, node_t **node_list, int list_size);
extern bool search_child_nodes(node_t *root_node, int node_index, node_t **node_list, int list_size);
